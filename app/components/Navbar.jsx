...
const Navbar = ({isDarkMode,setIsDarkMode}) => {
  ...
  return (
    <>
     <div className='fixed top-0 right-0 w-11/12
      -z-10 translate-y-[-80%] dark:hidden'>
      ...
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%]
       ...
       : ""} `}>
         <a href="#top"> {/* when clicked goes to the top of the page. */}
        ...
        <button onClick={()=>setIsDarkMode(val=>!val)}>
