        ...
        <h2 className='text-center text-5xl font-Ovo'>
            ...
            <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
             ...
             <div className='flex-1'>
                <p className='mb-10 max-w-2xl font-Ovo'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam natus nesciunt tempore totam, obcaecati doloremque veritatis quidem incidunt itaque nulla exercitationem minima consectetur? Dolor deserunt minus voluptates, sed ad natus.</p>
